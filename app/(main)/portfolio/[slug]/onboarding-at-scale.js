  ...
  return (
    <div className="case-study">
      ...
      <section className="case-study-section">
        ...
        <ul>
          <li>Made hidden onboarding effort and scale risk visible to leadership for the first time.</li>
          <li>Shifted decisions from reactive fixes to systemic prioritization based on real constraints.</li>
          <li>Enabled clearer ownership and more deliberate choices about what to automate, support manually, or redesign.</li>
        </ul>
        <h2>Problem</h2>
        <p>
        ...
        <section className="case-study-section">
          ...
          <p>This work focused on making invisible dependencies visible before they failed at scale.</p>
          ...
          <p>I designed a phased discovery system that operated alongside onboarding itself. The goal was not just to gather insights, but to create an ongoing feedback loop that reflected how onboarding actually functioned in practice. Internal discovery established a grounded baseline by tracing real customer onboarding end to end: reviewing tickets, Slack threads, meeting recordings, delivery plans, and handoffs to identify where progress depended on manual intervention or specific individuals.</p>
          ...
          <p>I proposed and designed a CSAT-based measurement framework to establish a baseline and track changes in customer confidence across key onboarding dimensions. The goal was not to optimize a single score, but to create a durable feedback loop that could surface where onboarding was improving, where it was regressing, and where hidden friction persisted as scale increased. While baseline collection was still in progress, this work established a shared, repeatable way to evaluate onboarding health from the customer’s perspective and guide future investment.</p>
          ...
          <p>This was not a single-team failure. Capacity delivery depended on coordination across sales, account executives, capacity planning, engineering, and customer experience - none of whom had a shared, real-time view of status or ownership. As a result, onboarding appeared to “work,” but only because teams absorbed misalignment manually and reactively.</p>
          <p>By making this dependency visible, I was able to bring the relevant teams together, clarify the underlying constraints, and inform the creation of an internal tool that provided a shared, up-to-date view of capacity status and changes. This reduced surprise, improved cross-team coordination, and addressed a scale risk that would have compounded rapidly as customer volume increased.</p>
