  ...
  return (
    <div className="intro">
      ...
      <section style={{ marginTop: '3rem', marginBottom: '3rem' }}>
        ...
        <p>At CoreWeave, I established the design function and led foundational platform work that shaped how the company thinks about AI infrastructure products. Today, my work focuses on designing platform systems that make complex technology legible, scalable, and trustworthy. I'm drawn to problems where structure matters - where the right abstraction or framework can unlock teams and products.</p>
