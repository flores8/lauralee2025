...
export default function Home() {
  return (
    <div className="intro">
      <h1>I'm Lauralee</h1>
      <p>I lead product experience at CoreWeave, where I built the design function from the ground up and now own the coherence of the company's core systems as they scale.
      </p>
      <p>
